    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 relative z-10">
        ...
        <header className="text-center mb-12 animate-fade-in-up">
          <div className="inline-block">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-white rounded-full mb-4 backdrop-blur-sm border border-blue-100 shadow-lg">
              ...
              <span className="text-sm font-semibold text-blue-700">Quick & Easy Booking</span>
            </div>
          </div>
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
            Complete your booking in just a few steps. No hidden fees, instant confirmation with premium service.
          </p>
        </header>

        {submitSuccess && (
          <div className="mb-6 sm:mb-8 p-4 sm:p-5 bg-gradient-to-br from-blue-50 to-white border-2 border-blue-200/80 rounded-3xl flex items-start gap-4 shadow-xl animate-fade-in-up">
            <div className="p-3 bg-gradient-to-r from-blue-100 to-white rounded-xl shrink-0 shadow-lg">
              <CircleCheck className="w-6 h-6 sm:w-7 sm:h-7 text-blue-600" />
            </div>
            <div>
              <p className="font-bold text-blue-900 text-lg">Booking Confirmed</p>
              <p className="text-sm text-blue-700 mt-0.5">
                Your reservation has been submitted. We'll send a confirmation to your email shortly.
              </p>
            </div>
          </div>
        )}
        ...
        <form
          ...
          className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border-2 border-blue-200/50 overflow-hidden animate-fade-in-up animation-delay-400"
        >
          <div className="p-6 sm:p-8 lg:p-10 grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border-2 border-blue-200/50 shadow-xl overflow-hidden">
                <div className="p-4 border-b border-blue-200/50 bg-gradient-to-r from-blue-50 to-white">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg text-white">
                      <Package className="w-5 h-5" />
                    </div>
                    <span className="font-bold text-gray-900">Add-ons & extras</span>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border-2 border-blue-200/50 shadow-xl overflow-hidden">
                <div className="p-4 border-b border-blue-200/50 bg-gradient-to-r from-blue-50 to-white">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-gray-900">Pricing details</span>
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full">
                      Est. ${total}
                    </span>
                  </div>
                ...
                <div className="p-4 bg-white/50">
                  <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-4 border-2 border-blue-200">
                    <div className="space-y-3">
                      <PriceRow label="Daily rate" value={`$${baseRate}`} icon={<CircleDollarSign className="w-4 h-4 text-blue-600" />} />
                      <PriceRow label="Security deposit" value={`$${deposit}`} icon={<Shield className="w-4 h-4 text-blue-600" />} />
                      {addonTotal > 0 && (
                        <PriceRow label="Add-ons" value={`$${addonTotal}`} icon={<Package className="w-4 h-4 text-blue-600" />} />
                      )}
                    ...
                    {/* Special offer */}
                    <div className="mt-4 p-3 bg-gradient-to-r from-yellow-100 to-orange-100 rounded-lg border-2 border-orange-300">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="text-sm font-bold text-orange-800">Limited Time Offer</p>
              ...
              >
                <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl p-4 border-2 border-blue-200">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-bold text-blue-800">Your Protection</span>
                  </div>
                  <ul className="text-sm text-gray-600 space-y-2">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-2">
                        <CircleCheck className="w-4 h-4 text-blue-600 shrink-0 mt-0.5" />
                        <span>{text}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <label className="mt-4 flex items-start gap-3 p-4 border-2 border-dashed border-blue-300 rounded-xl cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all">
                  <input
                    type="checkbox"
                    ...
                    className="mt-1 w-5 h-5 text-blue-600 rounded-2 border-blue-300 focus:ring-blue-500"
                  />
                  <div>
                    <span className="text-sm font-medium text-gray-900">I agree to rental terms and conditions</span>
              ...
              >
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-5 text-white">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <a href="mailto:support@velocityrentals.com" className="bg-white/10 hover:bg-white/20 transition-colors rounded-lg p-3 text-center">
          ...
          <div className="px-6 sm:px-8 lg:px-10 py-6 bg-gradient-to-r from-blue-50 to-white border-t-2 border-blue-200">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-2xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-3 shadow-xl shadow-blue-500/30 hover:shadow-2xl hover:shadow-blue-500/40"
              >
                {isSubmitting ? (
                  <>
